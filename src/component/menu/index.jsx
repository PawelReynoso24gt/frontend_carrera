...
<Dropdown
              name="Gestión de Bitácora"
              dropdown={dropdown}
              setDropdown={handleDropdown}
              options={[
                { link: "categoria_bitacoras", title: "Gestión Categoría Bitácora" },
                { link: "bitacoras", title: "Vista de Bitácora" },
              ]}
              img={
          ...
          {[
            ...
            >
              <Link to={`/${item.link}`}>
                <span className="menu-bar__icon"style={{ marginRight: "12px" }} >{item.icon}</span>
